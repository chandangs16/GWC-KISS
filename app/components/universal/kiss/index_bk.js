...
export class KissUniverse extends Component {
  ...
  componentDidMount() {
    ...
    //console.log("ASURITE ID ", asurite)
  ...
  submitAnswer() {
    ...
    let apiService = new ApiService("/prod", this.state.tokens_Kiss);
    ...
    apiService.post("/prod/getquestion", { "subject_code": this.props.navigation.state.params.data }, {"service":"","region":""}, {
      ...
      .then(responseData => {
        ...
        if (data.question == null) {
          ...
          console.log("Question receivd ", questionString);
    ...
    return (
      <View style={styles.container}>
        ...
        <CardSection style={styles.cardSectionStyle2}>
          <Button  title="Go Back" onPress={() => navigate("KissUniverse", {data: "Go back"})}/>
        </CardSection>
