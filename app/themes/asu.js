...
const bug_fix = StyleSheet.create({
  ios_image_container: {  // random position colors effecting heros
    position: 'absolute',
    backgroundColor: palette.none,
  },
  ios_default_text: { // default ios text has a default backgroundColor of white
    color: palette.black,
    backgroundColor: palette.none,
  },
});
